const BottomMenu = () => {
  return (
    <nav className="fixed bottom-10 left-0 right-0 flex items-center gap-5 md:w-4/12 lg:w-3/12 mx-auto justify-center bg-black text-white p-5 shadow rounded z-40">
