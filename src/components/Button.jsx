export const Button = ({type, textButton}) => {
    return (
        <button className={`col-start-5 col-end-9 row-start-6 row-end-7 relative p-[9px] overflow-hidden text-black font-semibold text-md transition-colors duration-300 hover:text-gray-300`}>
